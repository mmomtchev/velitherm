...
*   For the sake of completeness, the third very common pressure callsign, **QFE**, can refer to two different things - in aviation, it usually means the aircraft altimeter setting used for approach and landing and it refers to a setting of the zero level aligned with the ground level of the airport, and not an actual calculation method, the method used is **QNH** in this case; it can also mean the ground pressure level when referring to weather stations - and in this case the **QFF** method will be used
# Example
